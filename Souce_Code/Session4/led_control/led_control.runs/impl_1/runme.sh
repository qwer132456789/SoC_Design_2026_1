...
HD_PWD='/home_cds/std013/SoC_Design_2026_1/SoC_Design_2026_1/Souce_Code/Session4/led_control/led_control.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log led_control.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source led_control.tcl -notrace
